...
const EditProfile = () => {
  ...
  useEffect(() => {
    ...
    if (profile.profile) {
      ...
      exProfile.location = isEmpty(exProfile.location)
        ? ""
        : exProfile.location;
      exProfile.status = isEmpty(exProfile.status) ? "" : exProfile.status;
      exProfile.githubusername = isEmpty(exProfile.githubusername)
        ? ""
        : exProfile.githubusername;
      exProfile.bio = isEmpty(exProfile.bio) ? "" : exProfile.bio;
      exProfile.social = isEmpty(exProfile.social) ? {} : exProfile.social;
      exProfile.social.twitter = isEmpty(exProfile.social.twitter)
        ? ""
        : exProfile.social.twitter;
      exProfile.social.facebook = isEmpty(exProfile.social.facebook)
        ? ""
        : exProfile.social.facebook;
      exProfile.social.linkedin = isEmpty(exProfile.social.linkedin)
        ? ""
        : exProfile.social.linkedin;
      exProfile.social.youtube = isEmpty(exProfile.social.youtube)
        ? ""
        : exProfile.social.youtube;
      exProfile.social.instagram = isEmpty(exProfile.social.instagram)
        ? ""
        : exProfile.social.instagram;
      ...
      setallValues({
        ...
        bio: exProfile.bio,
        twitter: exProfile.social.twitter,
        facebook: exProfile.social.facebook,
        linkedin: exProfile.social.linkedin,
        youtube: exProfile.social.youtube,
        instagram: exProfile.social.instagram,
      });
    }
  }, [profile.profile]);
              ...
              <div className="mb-3">
                <button
                  ...
                  onClick={() => {
                    setallValues({
                      ...allValues,
                      displaySocialInputs: !allValues.displaySocialInputs,
                    });
                  }}
